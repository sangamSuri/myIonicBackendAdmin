...
String sem = request.getParameter("sem");
 Class.forName("com.mysql.jdbc.Driver");
          ...
          ResultSet rs = getdetsils.executeQuery("select * from faculty where dept='"+dept+"'");
          while(rs.next()){
              //System.out.println(rs.getString("studentUSN"));
              %>
              <tr>
              <td><%= rs.getString("Fname").toString() %></td>
              <td><%= rs.getString("usn_id").toString() %></td>
              <td><%= rs.getString("facstatus").toString() %></td>
              <td><a href="fstatus.jsp?id=<%= rs.getString("usn_id").toString().trim()%>">Status</a></td>
              <tr>
            <%
          }
